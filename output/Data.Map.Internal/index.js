                        ...
                        var go = function (v) {
                            ...
                            if (v instanceof Three) {
                                return appendFn(appendFn(appendFn(appendFn((function () {
                                    var $631 = tooSmall(v.value1);
                                    if ($631) {
                                        return memptyValue;
                                    };
                                    return go(v.value0);
                                })())((function () {
                                    var $632 = inBounds(v.value1);
                                    if ($632) {
                                        return f(v.value1)(v.value2);
                                    };
                                    return memptyValue;
                                })()))((function () {
                                    var $633 = tooSmall(v.value4) || tooLarge(v.value1);
                                    if ($633) {
                                        return memptyValue;
                                    };
                                    return go(v.value3);
                                })()))((function () {
                                    var $634 = inBounds(v.value4);
                                    if ($634) {
                                        return f(v.value4)(v.value5);
                                    };
                                    return memptyValue;
                                })()))((function () {
                                    var $635 = tooLarge(v.value4);
                                    if ($635) {
                                        return memptyValue;
                                    };
                                    return go(v.value6);
...
var filterWithKey = function (dictOrd) {
    return function (predicate) {
        var $749 = fromFoldable(dictOrd)(Data_List_Lazy_Types.foldableList);
        var $750 = Data_List_Lazy.filter(Data_Tuple.uncurry(predicate));
        var $751 = toUnfoldable(Data_List_Lazy_Types.unfoldableList);
        return function ($752) {
            return $749($750($751($752)));
        };
    };
};
...
var filterKeys = function (dictOrd) {
    return function (predicate) {
        return filterWithKey(dictOrd)(function ($753) {
            return Data_Function["const"](predicate($753));
        });
    };
};
        ...
        return function (z) {
            return function (m) {
                return Data_Foldable.foldl(Data_List_Types.foldableList)((function () {
                    var $754 = Data_Function.flip(f);
                    return function ($755) {
                        return Data_Tuple.uncurry($754($755));
                    };
...
var mapMaybe = function (dictOrd) {
    var $756 = mapMaybeWithKey(dictOrd);
    return function ($757) {
        return $756(Data_Function["const"]($757));
    };
};
        ...
        return function (k) {
            return function (v) {
                return alter(dictOrd)((function () {
                    var $760 = Data_Maybe.maybe(v)(Data_Function.flip(f)(v));
                    return function ($761) {
                        return Data_Maybe.Just.create($760($761));
                    };
                })())(k);
            };
        };
        ...
        return function (m1) {
            return function (m2) {
                var go = function (m) {
                    return function (v) {
                        return alter(dictOrd)((function () {
                            var $762 = Data_Maybe.maybe(v.value1)(f(v.value1));
                            return function ($763) {
