...
var renderCommand1Arg = function (s_) {
    return function (ref) {
        return function (a_) {
            return renderCommand(ref)(s_) + Data_Show.show(Data_Show.showNumber)(a_);
        };
    };
};
...
var renderCommand2Args = function (s_) {
    return function (ref) {
        return function (a_) {
            return function (b) {
                return renderCommand(ref)(s_) + (Data_Show.show(Data_Show.showNumber)(a_) + (", " + Data_Show.show(Data_Show.showNumber)(b)));
            };
        };
    };
};
    ...
    return function (ref) {
        return function (a_) {
            return function (b) {
                return function (c_) {
                    return function (d_) {
                        return renderCommand(ref)(s_) + (Data_Show.show(Data_Show.showNumber)(a_) + (", " + (Data_Show.show(Data_Show.showNumber)(b) + (", " + (Data_Show.show(Data_Show.showNumber)(c_) + (", " + Data_Show.show(Data_Show.showNumber)(d_)))))));
                    };
                };
            };
        };
        ...
        return function (y1_) {
            return function (x2_) {
                return function (y2_) {
                    return function (x_) {
                        return function (y_) {
                            return renderCommand(ref)("c") + (Data_Show.show(Data_Show.showNumber)(x1_) + (", " + (Data_Show.show(Data_Show.showNumber)(y1_) + (", " + (Data_Show.show(Data_Show.showNumber)(x2_) + (", " + (Data_Show.show(Data_Show.showNumber)(y2_) + (Data_Show.show(Data_Show.showNumber)(x_) + (", " + Data_Show.show(Data_Show.showNumber)(y_))))))))));
                        };
                    };
                };
            };
            ...
            return function (rot) {
                return function (arc) {
                    return function (sweep) {
                        return function (x_) {
                            return function (y_) {
                                return renderCommand(ref)("a") + (Data_Show.show(Data_Show.showNumber)(rx_) + (", " + (Data_Show.show(Data_Show.showNumber)(ry_) + (", " + (Data_Show.show(Data_Show.showNumber)(rot) + (printCommandArcChoice(arc) + (" " + (printCommandSweepChoice(sweep) + (Data_Show.show(Data_Show.showNumber)(x_) + (" " + Data_Show.show(Data_Show.showNumber)(y_)))))))))));
                            };
                        };
                    };
                };
