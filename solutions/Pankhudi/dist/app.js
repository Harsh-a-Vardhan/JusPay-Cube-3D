...
(function($PS) {
  ...
  var rotate = function (v) {
      ...
      var $99 = rotateZ(v.za);
      var $100 = rotateY(v.ya);
      var $101 = rotateX(v.xa);
      return function ($102) {
  ...
  var renderView = function (state) {
      ...
      return Halogen_HTML_Elements.div([  ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ renderButton("rotX++")(new IncAngVelocity(X.value, state.id)), renderButton("rotY++")(new IncAngVelocity(Y.value, state.id)), renderButton("rotZ++")(new IncAngVelocity(Z.value, state.id)), renderButton("reverse")(new ReverseCube(state.id)), renderButton("Vel++")(new IncVelocity(state.id)), renderButton("Vel--")(new DecVelocity(state.id)), renderButton("AddCube")(AddCube.value), renderButton("RemoveCube")(RemoveCube.value) ])([ Halogen_Svg_Elements.svg([ Halogen_Svg_Attributes.viewBox(0.0)(0.0)(viewBoxSize)(viewBoxSize) ])([ Halogen_Svg_Elements.g([  ])(drawCube(state.shape.edges)(vert2Ds)) ]) ]));
  };
  ...
  var incAngVelocity = function (axis) {
      return function (id) {
          return function (c) {
              ...
              throw new Error("Failed pattern match at Cube (line 187, column 3 - line 190, column 137): " + [ axis.constructor.name ]);
          };
      };
  };
  var cubes = (function () {
      ...
      var handleAction = function (query) {
          ...
          throw new Error("Failed pattern match at Cube (line 166, column 30 - line 173, column 66): " + [ query.constructor.name ]);
      };
