...
(function($PS) {
  ...
  var SpeedAngVelocity = (function () {
      function SpeedAngVelocity() {

      };
      SpeedAngVelocity.value = new SpeedAngVelocity();
  ...
  var DampenVelocity = (function () {
      ...
      DampenVelocity.value = new DampenVelocity();
  ...
  var speedAngVelocity = function (c) {
      return {
          shape: c.shape,
          angVel: c.angVel,
          forward: c.forward,
  ...
  var project = function (p) {
      ...
      return Halogen_HTML_Elements.div([  ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ renderButton("rotX++")(new IncAngVelocity(X.value)), renderButton("rotY++")(new IncAngVelocity(Y.value)), renderButton("rotZ++")(new IncAngVelocity(Z.value)), renderButton("reverse")(Reverse.value), renderButton("speed++")(SpeedAngVelocity.value), renderButton("speed--")(DampenVelocity.value), renderButton("add cube")(AddCube.value), renderButton("remove cube")(RemoveCube.value) ])([ Halogen_Svg_Elements.svg([ Halogen_Svg_Attributes.viewBox(0.0)(0.0)(viewBoxSize)(viewBoxSize) ])([ Halogen_Svg_Elements.g([  ])(drawCube(state.shape.edges)(vert2Ds)) ]) ]));
  };
  ...
  var incAngVelocity = function (axis) {
      return function (c) {
          ...
          throw new Error("Failed pattern match at Cube (line 178, column 3 - line 181, column 114): " + [ axis.constructor.name ]);
      };
  };
  var cubes = (function () {
      ...
      var handleQuery = function (v) {
          ...
          throw new Error("Failed pattern match at Cube (line 167, column 23 - line 172, column 26): " + [ v.constructor.name ]);
      };
      var handleAction = function (query) {
          ...
          if (query instanceof SpeedAngVelocity) {
              return runFunction(function (c) {
                  return Data_Functor.map(Data_Functor.functorArray)(speedAngVelocity)(c);
              });
          };
          if (query instanceof DampenVelocity) {
              return runFunction(function (c) {
                  return Data_Functor.map(Data_Functor.functorArray)(dampenVelocity)(c);
              });
          };
          if (query instanceof AddCube) {
              return runFunction(function (c) {
                  return Data_Array.insert(Data_Ord.ordRecord()(Data_Ord.ordRecordCons(Data_Ord.ordRecordCons(Data_Ord.ordRecordCons(Data_Ord.ordRecordCons(Data_Ord.ordRecordNil)()(new Data_Symbol.IsSymbol(function () {
                      return "speedBy";
          ...
          throw new Error("Failed pattern match at Cube (line 157, column 30 - line 164, column 55): " + [ query.constructor.name ]);
      };
