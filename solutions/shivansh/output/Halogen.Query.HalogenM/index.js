            ...
            return function (label) {
                return function (q) {
                    ...
                    return Control_Monad_Free.liftF(new ChildQuery(Halogen_Query_ChildQuery.mkChildQueryBox(new Halogen_Query_ChildQuery.ChildQuery(function (dictApplicative) {
                        return function (k) {
                            var $126 = Data_Functor.map((dictApplicative.Apply0()).Functor0())(catMapMaybes(dictOrd));
                            var $127 = Data_Traversable.traverse(Data_Map_Internal.traversableMap)(dictApplicative)(k);
                            var $128 = Halogen_Data_Slot.slots()(dictIsSymbol)(dictOrd)(label);
                            return function ($129) {
...
var monadTellHalogenM = function (dictMonadTell) {
    return {
        tell: (function () {
            var $135 = Control_Monad_Writer_Class.tell(dictMonadTell);
            return function ($136) {
                return HalogenM(Control_Monad_Free.liftF(Lift.create($135($136))));
            };
        })(),
...
var monadThrowHalogenM = function (dictMonadThrow) {
    return {
        throwError: (function () {
            var $137 = Control_Monad_Error_Class.throwError(dictMonadThrow);
            return function ($138) {
            ...
            var go = function (v1) {
                ...
                if (v1 instanceof Subscribe) {
                    return new Subscribe((function () {
                        var $143 = Data_Functor.map(Halogen_Subscription.functorEmitter)(f);
                        return function ($144) {
                            return $143(v1.value0($144));
                        };
                    })(), v1.value1);
                };
                if (v1 instanceof Unsubscribe) {
            ...
            var go = function (v1) {
                if (v1 instanceof State) {
                    return new State((function () {
                        var $145 = Data_Functor.map(Data_Tuple.functorTuple)(f);
                        return function ($146) {
                            return $145(v1.value0(f$prime($146)));
                        };
                    })());
                };
                if (v1 instanceof Subscribe) {
        ...
        map: function (f) {
            return function (v) {
                if (v instanceof State) {
                    return new State((function () {
                        var $147 = Data_Bifunctor.lmap(Data_Bifunctor.bifunctorTuple)(f);
                        return function ($148) {
                            return $147(v.value0($148));
                        };
                    })());
                };
                if (v instanceof Subscribe) {
                    return new Subscribe(v.value0, function ($149) {
                        return f(v.value1($149));
                    });
                };
                ...
                if (v instanceof Fork) {
                    return new Fork(v.value0, function ($150) {
                        return f(v.value1($150));
                    });
                };
                ...
                if (v instanceof GetRef) {
                    return new GetRef(v.value0, function ($151) {
...
var parallelHalogenM = {
    parallel: function ($152) {
        return HalogenAp(Control_Applicative_Free.liftFreeAp($152));
    },
    sequential: function ($153) {
        return HalogenM(Control_Monad_Free.liftF(Par.create($153)));
    },
    Monad0: function () {
        return monadHalogenM;
    },
