...
var lastDayOfMonth = function (y) {
    return function (m) {
        var unsafeDay = (function () {
            var $105 = Data_Maybe.fromJust();
            var $106 = Data_Enum.toEnum(Data_Date_Component.boundedEnumDay);
            return function ($107) {
                return $105($106($107));
            };
        })();
...
var enumDate = {
    succ: function (v) {
        ...
        var sd = (function () {
            ...
            var $70 = Data_Ord.greaterThan(Data_Maybe.ordMaybe(Data_Date_Component.ordDay))(v1)(new Data_Maybe.Just(l));
            if ($70) {
        ...
        var y$prime = (function () {
            var $72 = Data_Maybe.isNothing(sd) && Data_Maybe.isNothing(sm);
            if ($72) {
        ...
        var d$prime = (function () {
            var $73 = Data_Maybe.isNothing(sd);
            if ($73) {
    ...
    pred: function (v) {
        ...
        var y$prime = (function () {
            var $78 = Data_Maybe.isNothing(pd) && Data_Maybe.isNothing(pm);
            if ($78) {
        ...
        var m$prime = (function () {
            var $79 = Data_Maybe.isNothing(pd);
            if ($79) {
        ...
        var d$prime = (function () {
            var $80 = Data_Maybe.isNothing(pd);
            if ($80) {
