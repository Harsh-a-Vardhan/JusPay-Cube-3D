...
var nubBy = function (p) {
    ...
    var $344 = go(Data_List_Internal.emptySet)(Data_List_Types.Nil.value);
    return function ($345) {
        return reverse($344($345));
    };
};
...
var groupAll = function (dictOrd) {
    var $349 = group(dictOrd.Eq0());
    var $350 = sort(dictOrd);
    return function ($351) {
        return $349($350($351));
    };
};
...
var modifyAt = function (n) {
    return function (f) {
        return alterAt(n)(function ($352) {
            return Data_Maybe.Just.create(f($352));
        });
    };
};
module.exports = {
