...
(function($PS) {
  ...
  var reverseDirection = function (id) {
      return function (c) {
          var $51 = id === c.id;
          if ($51) {
              return {
  ...
  var renderView = function (state) {
      ...
      return Halogen_HTML_Elements.div([  ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ renderButton("rotX++")(new IncAngVelocity(X.value)), renderButton("rotY++")(new IncAngVelocity(Y.value)), renderButton("rotZ++")(new IncAngVelocity(Z.value)), renderButton("Reverse")(new ReverseDirection(state.id)), renderButton("Speed Increase")(new IncVelocity(state.id)), renderButton("Speed Decrease")(new DecVelocity(state.id)), renderButton("Add")(AddCube.value), renderButton("Remove")(RemoveCube.value) ])([ Halogen_Svg_Elements.svg([ Halogen_Svg_Attributes.viewBox(0.0)(0.0)(viewBoxSize)(viewBoxSize) ])([ Halogen_Svg_Elements.g([  ])(drawCube(state.shape.edges)(vert2Ds)) ]) ]));
  };
  ...
  var incAngVelocity = function (axis) {
      return function (c) {
          ...
          throw new Error("Failed pattern match at Cube (line 155, column 3 - line 161, column 118): " + [ axis.constructor.name ]);
      };
  };
  var cubes = (function () {
      ...
      var handleQuery = function (v) {
          ...
          throw new Error("Failed pattern match at Cube (line 144, column 23 - line 149, column 26): " + [ v.constructor.name ]);
      };
      var handleAction = function (query) {
          ...
          if (query instanceof ReverseDirection) {
              return runFunction(function (c) {
                  return Data_Functor.map(Data_Functor.functorArray)(reverseDirection(query.value0))(c);
              });
          };
          ...
          throw new Error("Failed pattern match at Cube (line 135, column 30 - line 142, column 68): " + [ query.constructor.name ]);
      };
