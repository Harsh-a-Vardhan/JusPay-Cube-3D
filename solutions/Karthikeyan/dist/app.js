...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Cube.cubes)(Data_Unit.unit)(body))(function (cube) {
          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Timer.setInterval(Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(1)(frameRate))(Halogen_Aff_Util.runHalogenAff(cube.query(Halogen_Query.mkTell(Cube.Tick.create)))));
      });
  }));
