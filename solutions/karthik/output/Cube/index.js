...
var project = function (p) {
    ...
    return Halogen_HTML_Elements.div([  ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ renderButton("rotX++")(new IncAngVelocity(X.value)), renderButton("rotY++")(new IncAngVelocity(Y.value)), renderButton("rotZ++")(new IncAngVelocity(Z.value)), renderButton("reverse")(new ReverseCube(state.id)), renderButton("Vel++")(new IncVelocity(state.id)), renderButton("Vel--")(new DecVelocity(state.id)), renderButton("AddCube")(AddCube.value), renderButton("RemoveCube")(RemoveCube.value), Halogen_HTML_Core.text("Direction" + Data_Show.show(Data_Show.showBoolean)(state.forward)), Halogen_HTML_Core.text("Speed" + Data_Show.show(Data_Show.showNumber)(state.speed)) ])([ Halogen_Svg_Elements.svg([ Halogen_Svg_Attributes.viewBox(0.0)(0.0)(viewBoxSize)(viewBoxSize) ])([ Halogen_Svg_Elements.g([  ])(drawCube(state.shape.edges)(vert2Ds)) ]) ]));
};
    ...
    return function (c) {
        if (axis instanceof X) {
            return {
                ...
                angVel: {
                    xa: (function () {
                        var $80 = c.forward === true;
                        if ($80) {
                            return c.angVel.xa + accelerateBy + c.speed;
                        };
                        return c.angVel.xa - accelerateBy - c.speed;
                    })(),
                    ya: c.angVel.ya,
        ...
        if (axis instanceof Y) {
            return {
                ...
                angVel: {
                    xa: c.angVel.xa,
                    ya: (function () {
                        var $81 = c.forward === true;
                        if ($81) {
                            return c.angVel.ya + accelerateBy + c.speed;
                        };
                        return c.angVel.ya - accelerateBy - c.speed;
                    })(),
                    za: c.angVel.za
            ...
            return {
                ...
                angVel: {
                    ...
                    za: (function () {
                        ...
                        if ($82) {
                            return c.angVel.za + accelerateBy + c.speed;
                        };
                        return c.angVel.za - accelerateBy - c.speed;
                    })()
                },
        ...
        throw new Error("Failed pattern match at Cube (line 221, column 3 - line 224, column 111): " + [ axis.constructor.name ]);
    };
};
var cubes = (function () {
    ...
    var handleQuery = function (v) {
        ...
        throw new Error("Failed pattern match at Cube (line 210, column 23 - line 215, column 26): " + [ v.constructor.name ]);
    };
    var handleAction = function (query) {
        ...
        if (query instanceof IncVelocity) {
            return runFunction(function (c) {
                return Data_Functor.map(Data_Functor.functorArray)(incVelocity(query.value0))(c);
            });
        };
        if (query instanceof DecVelocity) {
            return runFunction(function (c) {
                return Data_Functor.map(Data_Functor.functorArray)(decVelocity(query.value0))(c);
            });
        };
        ...
        throw new Error("Failed pattern match at Cube (line 200, column 30 - line 207, column 68): " + [ query.constructor.name ]);
    };
