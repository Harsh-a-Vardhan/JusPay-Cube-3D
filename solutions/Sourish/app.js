...
(function($PS) {
  ...
  var project = function (p) {
      ...
      var $69 = state.id === 0;
      if ($69) {
          return Halogen_HTML_Elements.div([  ])([ renderButton("rotX++")(new IncAngVelocity(X.value)), renderButton("rotY++")(new IncAngVelocity(Y.value)), renderButton("rotZ++")(new IncAngVelocity(Z.value)), renderButton("add")(Add.value), renderButton("remove")(RemoveIt.value) ]);
      };
      return Halogen_HTML_Elements.div([  ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ renderButton("reverse")(new Reverse(state.id)), renderButton("speed++")(new SpeedUp(state.id)), renderButton("speed--")(new SpeedDown(state.id)) ])([ Halogen_Svg_Elements.svg([ Halogen_Svg_Attributes.viewBox(0.0)(0.0)(viewBoxSize)(viewBoxSize) ])([ Halogen_Svg_Elements.g([  ])(drawCube(state.shape.edges)(vert2Ds)) ]) ]));
  };
  ...
  var decAngVelocity = function (axis) {
      return function (c) {
          ...
          throw new Error("Failed pattern match at Cube (line 266, column 3 - line 269, column 49): " + [ axis.constructor.name ]);
      };
  };
  var incAngVelocity = function (axis) {
      return function (c) {
          ...
          throw new Error("Failed pattern match at Cube (line 246, column 3 - line 250, column 116): " + [ axis.constructor.name ]);
      };
  };
  var cubes = (function () {
      ...
      var handleQuery = function (v) {
          ...
          throw new Error("Failed pattern match at Cube (line 221, column 23 - line 226, column 26): " + [ v.constructor.name ]);
      };
      var handleAction = function (query) {
          ...
          throw new Error("Failed pattern match at Cube (line 209, column 30 - line 217, column 53): " + [ query.constructor.name ]);
      };
