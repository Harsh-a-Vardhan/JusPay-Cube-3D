...
import Data.Array (mapWithIndex, (!!), cons, drop, length, insert, insertAt,dropEnd)
import Data.Array.NonEmpty (findLastIndex, reverse)
...
addValue val arr=insert val{id=length arr +1} arr
