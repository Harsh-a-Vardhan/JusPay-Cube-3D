...
(function($PS) {
  ...
  var SpeedUp = (function () {
      function SpeedUp(value0) {
          this.value0 = value0;
      };
      SpeedUp.create = function (value0) {
          return new SpeedUp(value0);
      };
      return SpeedUp;
  })();
  var SpeedDown = (function () {
      function SpeedDown(value0) {
          this.value0 = value0;
      };
      SpeedDown.create = function (value0) {
          return new SpeedDown(value0);
      };
      return SpeedDown;
  })();
  var Add = (function () {
  ...
  var rotate = function (v) {
      ...
      var $105 = rotateZ(v.za);
      var $106 = rotateY(v.ya);
      var $107 = rotateX(v.xa);
      return function ($108) {
  ...
  var renderView = function (state) {
      var renderText = function (label) {
          return Halogen_HTML_Elements.h1([  ])([ Halogen_HTML_Core.text(label) ]);
      };
      ...
      var getstring = Data_Int.toStringAs(Data_Int.decimal)(state.id);
      ...
      var $69 = state.id === 0;
      if ($69) {
          return Halogen_HTML_Elements.div([  ])([ renderText("Please Click on ADD button"), renderButton("rotX++")(new IncAngVelocity(X.value)), renderButton("rotY++")(new IncAngVelocity(Y.value)), renderButton("rotZ++")(new IncAngVelocity(Z.value)), renderButton("add")(Add.value), renderButton("remove")(RemoveIt.value) ]);
      };
      return Halogen_HTML_Elements.div([  ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ renderText(getstring), renderButton("reverse")(new Reverse(state.id)), renderButton("speed++")(new SpeedUp(state.id)), renderButton("speed--")(new SpeedDown(state.id)) ])([ Halogen_Svg_Elements.svg([ Halogen_Svg_Attributes.viewBox(0.0)(0.0)(viewBoxSize)(viewBoxSize) ])([ Halogen_Svg_Elements.g([  ])(drawCube(state.shape.edges)(vert2Ds)) ]) ]));
  };
  var removeValue = function (arr) {
      return Data_Array.dropEnd(1)(arr);
  };
  ...
  var addValue = function (val) {
      return function (arr) {
          return Data_Array.insert(Data_Ord.ordRecord()(Data_Ord.ordRecordCons(Data_Ord.ordRecordCons(Data_Ord.ordRecordCons(Data_Ord.ordRecordCons(Data_Ord.ordRecordCons(Data_Ord.ordRecordNil)()({
          ...
          })(Data_Ord.ordArray(Data_Tuple.ordTuple(Data_Ord.ordInt)(Data_Ord.ordInt))))))()({
              reflectSymbol: function () {
                  return "myval";
              }
          })(Data_Ord.ordNumber))()({
          ...
          })(Data_Ord.ordRecord()(Data_Ord.ordRecordCons(Data_Ord.ordRecordCons(Data_Ord.ordRecordCons(Data_Ord.ordRecordNil)()({
              reflectSymbol: function () {
                  return "za";
              }
          })(Data_Ord.ordNumber))()({
  ...
  var accelerateBy = oneDegInRad * myvalue;
  var decAngVelocity = function (axis) {
      return function (c) {
          ...
          throw new Error("Failed pattern match at Cube (line 275, column 3 - line 278, column 49): " + [ axis.constructor.name ]);
      };
  };
      ...
      return function (c) {
          if (axis instanceof X) {
              return {
                  ...
                  angVel: {
                      xa: (function () {
                          var $90 = c.forward === true;
                          if ($90) {
                              return c.angVel.xa + (accelerateBy + c.myval);
                          };
                          return c.angVel.xa - (accelerateBy + c.myval);
                      })(),
                      ya: c.angVel.ya,
          ...
          if (axis instanceof Y) {
              return {
                  ...
                  angVel: {
                      xa: c.angVel.xa,
                      ya: (function () {
                          var $91 = c.forward === true;
                          if ($91) {
                              return c.angVel.ya + (accelerateBy + c.myval);
                          };
                          return c.angVel.ya - (accelerateBy + c.myval);
                      })(),
                      za: c.angVel.za
          ...
          if (axis instanceof Z) {
              return {
                  ...
                  angVel: {
                      ...
                      ya: c.angVel.ya,
                      za: (function () {
                          var $92 = c.forward === true;
                          if ($92) {
                              return c.angVel.za + (accelerateBy + c.myval);
                          };
                          return c.angVel.za - (accelerateBy + c.myval);
                      })()
                  },
          ...
          throw new Error("Failed pattern match at Cube (line 255, column 3 - line 259, column 116): " + [ axis.constructor.name ]);
      };
  };
  var cubes = (function () {
      ...
      var handleQuery = function (v) {
          if (v instanceof Tick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Functor.map(Data_Functor.functorArray)(function (c) {
                  return tick(c);
              })))(function () {
          ...
          throw new Error("Failed pattern match at Cube (line 230, column 23 - line 235, column 26): " + [ v.constructor.name ]);
      };
      var handleAction = function (query) {
          if (query instanceof DecAngVelocity) {
              return runFunction(Data_Functor.map(Data_Functor.functorArray)(function (c) {
                  return decAngVelocity(query.value0)(c);
              }));
          };
          ...
          if (query instanceof Reverse) {
              return runFunction(Data_Functor.map(Data_Functor.functorArray)(function (c) {
                  return reversecube(c)(query.value0);
              }));
          };
          if (query instanceof SpeedUp) {
              return runFunction(Data_Functor.map(Data_Functor.functorArray)(function (c) {
                  return speedup(c)(query.value0);
              }));
          };
          if (query instanceof SpeedDown) {
              return runFunction(Data_Functor.map(Data_Functor.functorArray)(function (c) {
                  return speeddown(c)(query.value0);
              }));
          };
          if (query instanceof Add) {
              return runFunction(function (c) {
                  return addValue(initCube)(c);
              });
          };
          if (query instanceof RemoveIt) {
              return runFunction(function (c) {
                  return removeValue(c);
              });
          };
          if (query instanceof GetScore) {
              return runFunction(Data_Functor.map(Data_Functor.functorArray)(function (c) {
                  return getscore(c);
              }));
          };
          throw new Error("Failed pattern match at Cube (line 217, column 30 - line 226, column 55): " + [ query.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
          initialState: Data_Function["const"](myinit),
          render: render,
